...
class GenericMethods { // 일반 클래스 안에 정의한 제네릭 메소드 예제
    public int method1(int a){    // 일반 메소드
        return a;
    }
    ...
    public <A,B,C> void method4(A a, B b,C c) { // 세개의 제네릭타입 사용
    ...
    public <T> void method5(T t) {
        //System.out.println(t.langth); // 오류, langth는 String클래스의 메서드. 제네릭 t는 아직 String이라고 단정 지을 수 없음
        System.out.println(t.equals("안녕")); // 모든 클래스의 부모인 Object의 메서드만 가능
    }
}
...
public class GenericMethod {
    public static void main(String[] args) {
        ...
        boolean bool2 = gm.method2(2.5 ,2.5); // <Double> 생략(소수점은 자바에서 기본적으로 Double로 받음)
