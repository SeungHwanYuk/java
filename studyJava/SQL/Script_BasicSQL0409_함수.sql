...
select * from 고객
where 도시 like '서울%' and 마일리지 between 15000 and 20000; -- '서울'에 사는 고객중에 마일리지가 15000점 이상 20000점 이하인 고객

select * from 고객
where 도시 in("춘천시","과천시") and 담당자직위 like '%이사'; -- '춘천' 또는 '과천'에 사는 고객중 담당자 직위에 '이사'가 들어가는 고객
